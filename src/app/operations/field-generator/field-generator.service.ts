...
export class FieldGeneratorService {
	...
	getFieldList(configuration): Observable<any> {
		...
		return this.http.post<any>(url, configuration).pipe(tap((fieldList: any) => { }),
	...
	postField(form: any): Observable<any> {
		...
		return this.http.post<any>(url, form).pipe(tap((newHero: any) => { }),
	...
	deleteField(id: string): Observable<any> {
		...
		return this.http.delete<any>(url).pipe(tap((field: any) => { }),
